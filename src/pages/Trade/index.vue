    ...
    <div class="content">
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="order in orderInfo.detailArrayList" :key="order.skuId">
          <li>
            <img :src="order.imgUrl" alt="" style="width:120px;height:100px">
          </li>
          <li>
            <p style="width:650px">
              {{order.skuName}}</p>
      ...
      <div class="bbs">
        <h5>买家留言：</h5>
        <textarea placeholder="建议留言前先与商家沟通确认" class="remarks-cont" v-model="storeMessage"></textarea>
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        let data = {
          ...
          paymentWay:'ONLINE',
          orderComment:this.storeMessage,
